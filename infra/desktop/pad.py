...
canvas.create_text(64, 42, text='interface-ai / desktop calibration', anchor='w',
                   fill='white', font=('DejaVu Sans', 24, 'bold'))
canvas.create_text(64, 78, text='Native input fixture · synthetic data only · 1280 × 800',
                   anchor='w', fill='#94a3b8', font=('DejaVu Sans', 12))
canvas.create_text(64, 137, text='POINTER TARGETS', anchor='w', fill='#475569',
...
for number, x, color in [(1, 80, '#2563eb'), (2, 300, '#7c3aed'), (3, 520, '#ea580c')]:
    ...
    canvas.create_text(x + 80, 215, text=str(number), fill='white', font=('DejaVu Sans', 24, 'bold'))
...
canvas.create_text(64, 350, text='KEYBOARD INPUT', anchor='w', fill='#475569',
                   font=('DejaVu Sans', 11, 'bold'))
entry = tk.Entry(root, font=('DejaVu Sans', 18), relief='solid', borderwidth=1)
entry.place(x=80, y=380, width=530, height=50)
status = tk.Label(root, text='Waiting for input…', bg='#f1f5f9', fg='#475569',
                  anchor='w', font=('DejaVu Sans', 16))
...
canvas.create_text(850, 137, text='SCROLL TEST', anchor='w', fill='#475569',
                   font=('DejaVu Sans', 11, 'bold'))
...
canvas.create_text(64, 716, text='The viewer cannot send input. Automation acts inside this isolated desktop.',
                   anchor='w', fill='#475569', font=('DejaVu Sans', 12))
canvas.create_text(64, 750, text='Banking workflow and LLM discovery are not implemented in this step.',
                   anchor='w', fill='#64748b', font=('DejaVu Sans', 11))
