...
- The user authorized the first implementation step: isolated desktop environment and screenshot/input smoke test (M1-01). Implement and verify that bounded step; the banking app, full replay engine, and model integration are later work.
